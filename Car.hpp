...
public:
    ...
    glm::mat4 getBodyTransform();
    glm::mat4 getBonnetTransform();
    glm::mat4 getTrunkTransform();
    glm::mat4 getFrontRightWheelTransform();
    glm::mat4 getFrontLeftWheelTransform();
    glm::mat4 getBackRightWheelTransform();
    glm::mat4 getBackLeftWheelTransform();
    //---
    void SetBoxParts();
    vector<Box> getBoxParts();
